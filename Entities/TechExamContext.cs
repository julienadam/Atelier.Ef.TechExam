...
{
    public static string CONN_STR = "Data Source=.;Initial Catalog=TechExam;Integrated Security=True;Application Name=EntityFramework; TrustServerCertificate=True";
